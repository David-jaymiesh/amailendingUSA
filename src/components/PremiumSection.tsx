          ...
          <div className="relative bg-gradient-dark rounded-3xl overflow-hidden shadow-elevated">
            ...
            <div className="p-10 md:p-16 lg:p-20">
              <div className="relative">
                ...
                <div className="flex flex-col sm:flex-row items-start gap-6 pt-10 border-t border-primary-foreground/[0.08]">
                  <a
                    href={CONTACT_LINK}
                    target="_blank"
                  ...
                  <p className="text-primary-foreground/30 text-sm font-light self-center">
