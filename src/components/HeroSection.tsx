          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <a
                ...
                className="group inline-flex items-center gap-3 font-heading font-medium text-base px-8 py-4 rounded-full border border-border text-foreground hover:bg-muted transition-colors"
              >
